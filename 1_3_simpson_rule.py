# to evaluate integral using simpson 1/3 rule
...
if n%2 !=0:
    ...
    print('The integral by simpsons 1/3 rule is :')
    print(I)    

plt.plot(x,ypoints,label = 'Partition points')
...
plt.fill_between(x_list,y_list, color='pink' , alpha = 0.2 , label = 'Area by Simpson 1/3 rule' )
